...
export const definitions: Definition[] = [
    {
        type: 'endurance',
        text: 'Endurance Day is a classic Zone 2 or “Steady State” day. This means RPE of about 7/10. If you\'re using a HR Monitor, your heart rate should be about 70% of your max, to minimize glycolytic activity. Your pace should remain constant throughout the entire session. Endurance Day increases blood pumped per heartbeat, by recruiting mainly slow twitch muscle fibers, which require lots of oxygen. Don\'t worry about going faster. Maintain your pace as the sessions get longer.',
